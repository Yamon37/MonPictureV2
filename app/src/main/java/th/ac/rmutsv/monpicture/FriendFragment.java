        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             ...
             for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()){
                ...
                FriendAdapter friendAdapter = new FriendAdapter(getActivity(), iconStringArrayList, nameStringArrayList, emailStringArrayList, new OnClickItem() {
                    @Override
                    public void onClickItem(View view, int position) {
                        ...
                        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.contentServiceFragment,
                                UserFragment.userInstance(nameStringArrayList.get(position),
